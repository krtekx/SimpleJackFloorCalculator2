...
const EraseIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M18 6L6 18" />
        <path d="M6 6l12 12" />
        <path d="M20 12l-8 8-4-4-8-8 4-4 8 8z" />
    </svg>
);
...
const PanIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M10 9.5V4a2 2 0 0 0-2-2v0a2 2 0 0 0-2 2v10.5a2.5 2.5 0 0 0 2.5 2.5h9.5a2 2 0 0 0 2-2v-3.36a2.2 2.2 0 0 0-.59-1.58L15.5 12Z" />
    </svg>
);


const SnapIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <path d="M4 12v-6a8 8 0 0 1 16 0v6"/>
    <path d="M4 12h5"/>
    <path d="M15 12h5"/>
...
const ZoomExtentsIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const FieldIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const TileIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    <rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect>
  </svg>
);
...
const ViewModeIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const Icon: React.FC<IconProps> = ({ icon, className }) => {
  switch (icon) {
    case 'POINTER': return <PointerIcon className={className} />;
    case 'WALL': return <WallIcon className={className} />;
    case 'MOVE': return <MoveIcon className={className} />;
    case 'ERASE': return <EraseIcon className={className} />;
    case 'PAN': return <PanIcon className={className} />;
    case 'SNAP': return <SnapIcon className={className} />;
    case 'UNDO': return <UndoIcon className={className} />;
    case 'REDO': return <RedoIcon className={className} />;
    case 'RESET': return <ResetIcon className={className} />;
    case 'STATS': return <StatsIcon className={className} />;
    case 'SAVE': return <SaveIcon className={className} />;
    case 'LOAD': return <LoadIcon className={className} />;
    case 'EYE_OPEN': return <EyeOpenIcon className={className} />;
    case 'EYE_CLOSED': return <EyeClosedIcon className={className} />;
    case 'ZOOM_IN': return <ZoomInIcon className={className} />;
    case 'ZOOM_OUT': return <ZoomOutIcon className={className} />;
    case 'ZOOM_EXTENTS': return <ZoomExtentsIcon className={className} />;
    case 'FIELD': return <FieldIcon className={className} />;
    case 'TILE': return <TileIcon className={className} />;
    case 'FILL': return <FillIcon className={className} />;
    case 'CUT': return <CutIcon className={className} />;
    case 'RESTORE': return <RestoreIcon className={className} />;
    case 'VIEW_MODE': return <ViewModeIcon className={className} />;
